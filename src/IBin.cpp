...
namespace IBin {
    ...
    std::wstring WTextToWBin(const std::wstring& text) {
    ...
    std::string TextToBin(const std::string& text) {
        std::stringstream ss{};
        for (size_t i = 0; i < text.size(); i++) 
    ...
    std::wstring WBinToWText(const std::wstring& bin) {
        std::wstringstream wss;
    ...
    std::string BinToText(const std::string& bin) {
        std::stringstream ss;
    ...
    std::wstring WBinFileToWText(const std::string& filename) {
    ...
    std::string BinFileToText(const std::string& filename) {
